...
namespace TFUND.MVC.Helper.Security.Test
{
    ...
    public class testEncryptDecrypt
    {
        ...
        public void Encrypt_String()
        {
            ...
            var StringKey = "สวัสดิรักษาสิทธิ์                                      asdfasdfasdf2tยนบนบงยนงวสฝ่สาเีดำไถพ--ภฟำดฟหกดฟหกดฟหดฟหกด                                 สวัสดิรักษาสิทธิ์                                      asdfasdfasdf2tยนบนบงยนงวสฝ่สาเีดำไถพ--ภฟำดฟหกดฟหกดฟหดฟหกด                                 ";
